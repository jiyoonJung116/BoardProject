...
<head>
	...
	<link href="resources/css/NoticeBoardJoin.css?after" rel="stylesheet" >
</head>
<body>
	<div class="signup-container">
        <h1>회원가입</h1>
        <form id="signupForm" action="joinComplete" method="POST">
            ...
            <input type="text" id="birthdate" name="birth" required>
            <br>
